  ...
  <div class="main-content-container container-fluid px-4">
    ...
    <div class="page-header row no-gutters py-4">
      <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
        ...
        <h3 class="page-title"><i class="icon-line-awesome-align-justify"></i> Category
        ...
        <div class="col-lg-12 mb-4">
          <div class="card card-small lo-stats h-100">
            <div class="card-header border-bottom">
              <h6 class="m-0">Latest Category</h6>
              ...
              <div class="row">
               <div class="col">
                  ...
                  <div class="col text-right view-report">
                    ...
                    <a>Showing 10 to <?php echo e(COUNT($Categores)); ?> of <?php echo e(COUNT($Categores)); ?> Category</a>
                    <?php else: ?>
                    <a>Showing 10 to 0 of 0 Category</a>
                    <?php endif; ?>
                  </div>
              </div>
            </div>
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/insanberbagi/insanberbagi/Charity/resources/views/dashboard/dashboardCategores/index.blade.php ENDPATH**/ ?>