...
<?php if($message = $errors->has('error')): ?>
...
<strong>Error!</strong> <?php echo e($errors->first('error')); ?></div>
<?php endif; ?>
        ...
        <div class="card card-small mb-3">
          <div class="card-body">
              ...
              <div class="form-control form-control-lg mb-3">
                ...
                <input class="form-control form-control-lg mb-3" type="text" placeholder="Your Post Seo Title" name="author_id" value="<?php echo e($Post->author_id); ?>">
                <!-- ====================== links Posts Content Start store =============================================== -->
              </div>
              <!-- ====================== links Posts Content Start store =============================================== -->
              <div class="form-control form-control-lg mb-3">
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\File PENS\develops\web-prak\Charity\resources\views/dashboard/dashboardPosts/edit.blade.php ENDPATH**/ ?>