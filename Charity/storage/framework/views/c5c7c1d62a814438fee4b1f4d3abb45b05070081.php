    ...
    <div class="main-content-container container-fluid px-4">
      ...
      <div class="page-header row no-gutters py-4">
        <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
          ...
          <h3 class="page-title"><i class=" icon-feather-file-text"></i> Gallery
            <a href="<?php echo e(route('dashboardGalleres.create')); ?>" class="mb-2 btn btn-success mr-2">
              <i class="icon-material-outline-add-circle-outline"></i> Add Gallery</a>
            </h3>  
          </div>
        </div>
        <!-- ====================== links Galleres Content Start =============================================== -->
          ...
          <div class="col-lg-12 mb-4">
            <div class="card card-small lo-stats h-100">
              <div class="card-header border-bottom">
                <h6 class="m-0">Latest Gallery</h6>
              ...
              <div class="card-footer border-top">
                <div class="row">
                  ...
                  <div class="col text-right view-report">
                    ...
                    <a>Showing 10 to <?php echo e(COUNT($Galleres)); ?> of <?php echo e(COUNT($Galleres)); ?> Gallery</a>
                    <?php else: ?>
                    <a>Showing 10 to 0 of 0 Gallery</a>
                    <?php endif; ?>
                    <!-- ====================== links Galleres Content Start =============================================== -->
                  </div>
                </div>
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/insanberbagi/insanberbagi/Charity/resources/views/dashboard/dashboardGalleres/index.blade.php ENDPATH**/ ?>