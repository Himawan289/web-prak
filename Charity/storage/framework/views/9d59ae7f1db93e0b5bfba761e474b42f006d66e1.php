		...
		<div class="container">
			<div class="row fullscreen justify-content-lg-begin">
				<div class="banner-content col-lg-7">
                    ...
                    <!-- Welcome Message -->
                    <?php if(Auth::check()): ?>
                        <p style="color: white; font-size: 1.5em;">Welcome, <?php echo e(Auth::user()->name); ?>!</p>
                    <?php endif; ?>
                    <!-- Welcome Message End -->
				</div>
			</div>
			...
			<div class="row justify-content-center">
				<div class="col-lg-8">
					...
					<div class="call-wrap mx-auto">
						...
						<p>In that Our I own life unto lights them two appear days is saying blessed</p>
						<a href="<?php echo e(url('register')); ?>" class="primary-btn mt-5">
							Sign up
							<i class="ti-angle-right ml-1"></i>
						</a>
					</div>
...
<?php echo $__env->make('english.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/insanberbagi/insanberbagi/Charity/resources/views/english/home.blade.php ENDPATH**/ ?>