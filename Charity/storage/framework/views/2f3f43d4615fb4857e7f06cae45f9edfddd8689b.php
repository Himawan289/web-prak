...
<div class="main-content-container container-fluid px-4">
    ...
    <div class="page-header row no-gutters py-4">
      <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
        ...
        <h3 class="page-title"><i class="icon-line-awesome-align-justify"></i> Category</h3>
      </div>
    </div>
    <!-- End Page Header -->
    <div class="row">
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/insanberbagi/insanberbagi/Charity/resources/views/dashboard/dashboardCategores/create.blade.php ENDPATH**/ ?>