  ...
  <div class="container">
    <div class="row justify-content-lg-end align-items-center banner-content">
      <div class="col-lg-5">
        ...
        <!-- ===============================  Contact  ======================================== -->
        <p>Jangan ragu untuk menghubungi kami jika Anda mengalami kendala atau memerlukan bantuan lebih lanjut. Kami siap membantu dengan senang hati!</p>
        <!-- ===============================  Contact  ======================================== -->
      </div>
    </div>
  </div>
    ...
    <div class="row">
      ...
      <div class="col-lg-4">
        ...
        <div class="media contact-info">
          ...
          <div class="media-body">
            <!-- ===============================  Contact  ======================================== -->
            <h3><a href="tel:<?php echo e(Setting()->PhoneNumber); ?>">0823456789</a></h3>
            <!-- ===============================  Contact  ======================================== -->
          </div>
        </div>
        <div class="media contact-info">
          ...
          <div class="media-body">
            <!-- ===============================  Contact  ======================================== -->
            <h3><a href="mailto:support@colorlib.com">support@charity.com</a></h3>
            <!-- ===============================  Contact  ======================================== -->
          </div>
        </div>
      </div>
...
<?php echo $__env->make('english.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/insanberbagi/insanberbagi/Charity/resources/views/english/Contact.blade.php ENDPATH**/ ?>