        ...
        <div class="container">
            ...
            <div class="event_content mb-40">
                <div class="row justify-content-center">
                    ...
                    <!--================ Start Popular Causes Area =================-->        
                    <form class="form-contact contact_form" method="POST" id="payment-form" action="<?php echo e(route('donate.store')); ?>">
                        <?php echo csrf_field(); ?>
                            ...
                            <ul class="list-group mt-10 text-center">
                                <?php $__currentLoopData = $donations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $donation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="list-group-item mt-1">
                                        <span class="font-weight-bold"><?php echo e($donation->name); ?></span> donated $<?php echo e($donation->amount); ?>
...
<?php echo $__env->make('english.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\File PENS\develops\web-prak\Charity\resources\views/english/Causes/show.blade.php ENDPATH**/ ?>